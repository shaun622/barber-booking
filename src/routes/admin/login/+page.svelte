...
<div class="mx-auto max-w-sm px-5 py-20">
  <p class="eyebrow rise rise-1">Balis Barber</p>
  ...
  <form method="POST" class="grid gap-4 rise rise-2">
    <label class="block">
      <span class="text-sm font-medium text-[var(--color-bone-dim)]">Password</span>
